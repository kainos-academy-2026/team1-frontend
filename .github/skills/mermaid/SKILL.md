---
name: mermaid
description: "Use when the user asks for documentation, diagrams, or mentions Mermaid. Analyzes a codebase and its tests to produce accurate, readable Mermaid diagrams."
argument-hint: "File name, workflow, process, sector, or area of the codebase to diagram"
---
...
- Diagrams rendered as fenced ` ```mermaid ` code blocks, scoped to the provided input
...
- Choose the most appropriate Mermaid diagram type for the content (e.g., `flowchart`, `sequenceDiagram`, `classDiagram`, `stateDiagram`)
